    ...
    return (
        <Tabs defaultActiveTab='Ideal Aerosmith'>
                ...
                <div className='pl-2'>
                    ...
                    {(panelState === 'Overview') &&
                        <Frame h='382px' w='78%' bgColor='white' boxShadow='$in' className='mt-5 p-2 overflow-y-scroll max-h-[80%]'>
                            ...
                            <Fieldset legend='Skills' className='pl-2 pr-2 pb-2 h-[50%]'>
                            ...
                            <p className='font-mono text-lg mt-2'>Contribute to the development of desktop applications for multi-axis motion control systems.</p>
                            <p className='font-mono text-lg mt-2'>Collaborate in an Agile Environment by participating in daily standups, sprint planning, and deliver software on schedule.</p>
                            <p className='font-mono text-lg mt-2'>Work within large TypeScript/Node.js codebases using Git-based version control, managing branching strategies and maintaining code quality through proper documentation and pull request reviews.</p>
                            ...
                            <p className='font-mono text-lg mt-2'>Participate in code reviews and software lifecycle processes, receiving constructive feedback for continuous improvement.</p>
                        </Frame>
                    }
                    {(panelState === 'InternGF') &&
                        <Frame h='382px' w='78%' bgColor='white' boxShadow='$in' className='mt-5 p-2 overflow-y-scroll'>
                            ...
                            <p className='font-mono text-lg mt-2'>Intern Grand Forks (GF) was a summer cohort where interns from companies in the Grand Forks (ND) community participated in networking and explorative activities.</p>
                            <p className='font-mono text-lg mt-2'>Twice a month many interns and I would meet up and participate in some kind of socializing game, then moved on to the activity for the day. I challenged myself to get out there and meet some new people which was not easy but really broke my shell! </p>
            ...
            <Tab title='CRC' className='font-mono'>
                <h1 className='font-mono text-3xl ml-2 mt-2 pb-1'> Computational Research Center - UND </h1>
                ...
                <Frame h='382px' w='95%' bgColor='white' boxShadow='$in' className='mt-5 ml-2 p-2 overflow-y-scroll'>
                    ...
                    <p className='font-mono text-lg mt-2'>Develop and maintain frontend features for the UND Arctic Labs research platform, creating interfaces for university researchers to utilize computational tools and resources.</p>
                    <p className='font-mono text-lg mt-2'>Ensure authentication and authorization to secure user access and protect sensitive research data, ensuring compliance with university security standards.</p>
